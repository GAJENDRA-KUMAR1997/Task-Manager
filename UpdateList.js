...
export default function UpdateList() {
  ...
  const onSubmitHandler = async(e) =>{
    e.preventDefault();
    const response = await fetch(`http://localhost:5000/api/updateList/${id}`,{
      method: "POST",
      headers: {
  ...
  return (
    <div style={myStyle1}>
    <div style={myStyle}>
    <div style={{height:"600px",width:"600px",display:"flex",flexDirection:'column',border:"1px solid black",alignItems:"center",background: "rgb(238,174,202)",
      ...
      <form style={{margin:"10px"}} onSubmit={onSubmitHandler}>
        <div className='d-flex flex-column' style={{width:"500px" , margin:"20px"}}>
        ...
        <div>
          <button type='submit' style={{width:"500px" , margin:"20px",padding:"5px",borderRadius:"5px",backgroundColor:"green",color:"white",fontSize:"20px"}}>Submit</button>
          <Link to="/"><button style={{width:"500px" , margin:"20px",padding:"5px",borderRadius:"5px",backgroundColor:"green",color:"white",fontSize:"20px"}}>My TaskList</button></Link>
